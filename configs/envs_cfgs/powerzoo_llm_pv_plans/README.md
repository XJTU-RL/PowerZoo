...
|------|--------|--------|--------|------------|----------|
| 保守 | powerzoo_llm_conservative.yaml | 720kW | 40.7% | 5个 | 低 |
| 优化 | powerzoo_llm_optimized.yaml | 900kW | 50.8% | 7个 | 中 |
| 激进 | powerzoo_llm_aggressive.yaml | 1080kW | 61% | 9个 | 高 |

## 🎯 方案详情

### 保守方案 (Conservative)
**文件**: `powerzoo_llm_conservative.yaml`
...
### 优化方案 (Optimized)
**文件**: `powerzoo_llm_optimized.yaml`
...
### 激进方案 (Aggressive)
**文件**: `powerzoo_llm_aggressive.yaml`
...
python train.py \
  --env powerzoo_llm \
  --env_config configs/envs_cfgs/pv_plans/powerzoo_llm_optimized.yaml
```
