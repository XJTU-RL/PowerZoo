...
"""
import os
from envs.power_envs.powerzoo_llm.base_env.powerzoo_env import PowerZooEnv, OptimizedPowerZooEnv
...
class PowerZooEnvWrapper:
    ...
    def create_base_env(config, env_name: str = "13Bus", scenario=None, **kwargs):
        ...
        Returns:
            PowerZooEnv实例
        """
        from envs.power_envs.powerzoo_llm.base_env.env_register import get_info_and_folder
