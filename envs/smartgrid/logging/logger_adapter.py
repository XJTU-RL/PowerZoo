# -*- coding: utf-8 -*-
"""
SmartGrid环境日志适配器 - 连接SystemLogger和base_logger
整合smartgrid专用的系统日志记录与通用训练日志记录
"""
...
# 使用统一日志系统
from envs.smartgrid.logging.system_logger import get_system_logger, close_system_logger
